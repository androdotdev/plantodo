...
<html lang="en">
<head><meta charset="utf-8"><title>Private post</title>
...
<p class="msg">The owner has marked this post as private. Sign in with the owner account to view it.</p>
...
export async function GET(
  ...
  return new NextResponse(injected, {
    headers: {
      ...
      "Content-Security-Policy": "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; connect-src 'none'; form-action 'none'; frame-ancestors 'none'",
